...
[Example of the Error Message: Type 'x' is not assignable to type 'y'](https://www.typescriptlang.org/play?#code/DYUwLgBAzmBOBc04EsB2BzCBeCAiAFsrgNwBQMs2EcAriMUA)
...
[Example of the Error Message: Property 'x' does not exist on type 'y'](https://www.typescriptlang.org/play?#code/MYewdgzgLgBADgUwE4XALhgbxmAhgWwQ2iQEswBzGAXxgF4sAoGHAomAIgCtcwEPGtRo0QpwAOlwUEQA)
...
[Example of the Error Message: Cannot find name 'x'](https://www.typescriptlang.org/play?#code/MYewdgziA2CmB00QHMAUAHWAnKYCUA3EA)
...
[Example of the Error Message: Parameter 'x' implicitly has an 'any' type](https://www.typescriptlang.org/play?ssl=3&ssc=2&pln=1&pc=1#code/GYVwdgxgLglg9mABABwE4zFAFANwIYA2IApgJSIDeAUIohAgM5wHEB0BcA5roSaQNxUAvkA)
...
[Example of the Error Message: The left-hand side of an arithmetic operation must be of type 'any', 'number', 'bigint' or an enum type](https://www.typescriptlang.org/play?#code/MYewdgzgLgBNBOMC8MBECCWYDmqDcAUKJLGAK4C2yMArEeNDAG4CGANmQKbUIwBUMchTxA)
...
[Example of the Error Message: Object is possibly 'null' or 'undefined'](https://www.typescriptlang.org/play?#code/MYewdgzgLgBAFiARoglgUwjAvDAFGAQwFs0AuGaAJxTAHMAaeJVDAfnKptoG0BdASmwA+GAG8AUDBihIIADZoAdHJC1cAAwAkowiQC+8Apm0Jk6CMrR0ocA6ZYX1-cXqA)
