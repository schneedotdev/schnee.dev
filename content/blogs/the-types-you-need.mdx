...
For further TypeScript exploration, I recommend heading back to my blog post [How to Learn and Use TypeScript: A Comprehensive Beginner's Guide](https://www.schnee.dev/blogs/how-to-learn-and-use-typescript-a-comprehensive-beginners-guide) where you'll next learn about how to benefit from your coding environment, read error messages and use TypeScript in your projects.
